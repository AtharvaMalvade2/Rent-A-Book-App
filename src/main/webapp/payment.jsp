...
%>
      <form style="display:flex;flex-direction:column;gap:15px;justify-content:center;" action="paymentprocess.jsp" method="post">
          <div class="form-group">
              <label for="PaymentAmount">Payment amount</label>
              <div class="amount-placeholder">
                  <span>&#8377;</span>
                  <input value="<%=rs.getString("book_price")%>" name="book_price" readonly>
              </div>
          </div>
          <div class="form-group">
              <label for="PaymentAmount">Book Id</label>
              <div class="amount-placeholder">
                  <input value="<%=rs.getString("book_id")%>" name="book_id" readonly>
              </div>
          </div>
          <div class="form-group" style="display:flex;flex-direction:column;gap:10px;">
              <label or="NameOnCard">Name on card</label>
              <input id="NameOnCard" class="form-control" name="card_name" type="text" maxlength="255"></input>
          </div>
          <div class="form-group" style="display:flex;flex-direction:column;gap:10px;">
              <label for="CreditCardNumber">Card number</label>
              <input id="CreditCardNumber" type="tel" name="card_number" inputmode="numeric" pattern="[0-9\s]{13,19}" autocomplete="cc-number" maxlength="16" placeholder="xxxx xxxx xxxx xxxx" class="null card-image form-control"></input>
          </div>
          <div class="expiry-date-group form-group" style="display:flex;flex-direction:column;gap:10px;">
              <label for="ExpiryDate">Expiry date</label>
              <input id="ExpiryDate" class="form-control" name="expiry_date" type="text" placeholder="MM / YY" maxlength="7"></input>
          </div>
          <div class="security-code-group form-group" style="display:flex;flex-direction:column;gap:10px;">
              <label for="SecurityCode">Security code</label>
              <div class="input-container" >
                  <input id="SecurityCode" class="form-control" name="cvv" type="password" maxlength="3" ></input>
