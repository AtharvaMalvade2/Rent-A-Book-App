...
<header>
      ...
      <nav>
        <ul class="nav__links">
          ...
          <li>
            <a href="#"
              ><i class="far fa-user-circle" style="margin-right: 10px"></i></i
              >User</a
            >
          </li>
          <li>
...
%>
    <table style="width: 96%;margin-left:26px;margin-right:26px;border-radius: 15px;border-collapse: collapse;box-shadow: 0px 1px 9px;text-align: center;margin-top:2rem;"><tr style="width: 100%; height: 200px; border: none;test-align:center;"><td border="0" style="width:25%;border-collapse: collapse;border: none;"><%=rs.getString("book_title") %></td>
            ...
            <td border="0" style="width:25%;border-collapse: collapse;border: none;display:flex;flex-direction:column;justify-content:center;align-items:center;margin-top:18%;margin-left:36%;gap:1rem;"><a href="rentnow.jsp?book_id=<%=rs.getString("book_id") %>"><button type="button" style="width:90px;height:35px;background-color:#000;color:#fff;border:none;border-radius:12px;">Rent Now</button></a></td></tr></table>
        <%
}
%>
    <%
